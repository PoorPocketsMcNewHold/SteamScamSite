This is a filter list repo, based on the [wishihab/steamscamsite scam list](https://github.com/wishihab/steamscamsite), as well from the [Aegis Team domains list](https://github.com/AegisTeam/Discord-Resources) with a couple of personally added found scam websites.
